...
tipo: fuente
fuentes: [raw/specs_reserva_v2.txt, raw/reservas/spec-funcional-reservas.md, raw/diagrama_bd.md]
creado: 2026-04-15
actualizado: 2026-04-16 (resoluciones adicionales: recordatorio solo confirmed, link externo = XSS, reserva hoy con slot vencido, reassignación sin restricción de dirección)
---

# Resumen del Spec Funcional de Reservas

Versión vigente: **v2** (`raw/specs_reserva_v2.txt`, ingresada 2026-04-16). Supera a `raw/reservas/spec-funcional-reservas.md` (v1, 2026-04-15). La v1 se conserva como antecedente histórico; cualquier contradicción entre ambas se resuelve a favor de v2. El diagrama en `raw/diagrama_bd.md` sigue siendo la referencia del esquema de tablas.
